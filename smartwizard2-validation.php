...
<link href="SmartWizard-master/styles/smart_wizard.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
    ...
    function validateAllSteps(){
      ...
      if(step == 1){
        if(validateStep1() == false ){
          isStepValid = false; 
          $('#wizard').smartWizard('showMessage','Por favor verifique los datos en el paso '+step+ ' y pulse el boton siguiente.');
